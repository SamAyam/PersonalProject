...
def ask_player(this_screen, gsize):
    ...
    buttnsB=[button1, button2, button3, button4, button5, button6, button7]
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                if (event.button)==1:
                    ...
                    if menu == 'main':
                        for bttn in buttnsA:
                            if bttn.rect.collidepoint(pos)==True:
                                if bttn.name == 'newgamebutton':
                                    menu = 'race'
                                elif bttn.name == 'loadgamebutton':
...
#                 if event.button==3:
                ...
                if event.key==K_BACKSLASH:
                    ...
                    quitgamebutton.x=width/4
                    quitgamebutton.y=fullheight*3/4
                    quitgamebutton.width=width//2
                    quitgamebutton.height=height//8
                    quitgamebutton.rect=pygame.Rect(quitgamebutton.x, quitgamebutton.y, quitgamebutton.width, quitgamebutton.height)
                    quitgamebutton.image = pygame.transform.scale(quitgamebutton.image, (quitgamebutton.width,quitgamebutton.height))
...
def new_game(gamesize, screen):
    ...
    gamevars.game_map, gamevars.current_location=loading_game()
    ...
    gamevars.current_location.environment=[('buildings',[building1]),
                                  ('spawnpoints',[]),
                                  ('jumpspot',[]),
                                  ('trees',[]),
                                  ('sandbags',[]),
...
def main_game_loop():
    ...
    gamevars.playerkind, gamevars.fullscrn=ask_player(gamevars.my_screen, gamesize)
    
    
    #this sets the invisible boundaries
    gamevars.set_boundaries()
    
    
    if gamevars.playerkind == 'loadgame':
