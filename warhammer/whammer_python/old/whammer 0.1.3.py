...
def planet_display(screen):
        global current_location, main_players 
        if current_location.above_planet==True: #this is if you are in planet assault mode
            screen.blit(current_location.big_pic, (current_location.gamex, current_location.gamey))
    ...
    #    screen.blit(background, (current_location.gamex, current_location.gamey))
...
def ask_player():
    ...
    # This will later be a menu in the game screen:
    try:
...
def main_game_loop():
    ...
    while not done:
        ...
        # First, clear the screen to grey. Don't put other drawing commands
        # above this, or they will be erased with this command.
    
    
        screen.fill((175, 175, 175)) # GREY
        ...
        if current_location.space_type=='none':   #this means it is a planet
            planet_display(screen)
        else:
            space_display(screen)
