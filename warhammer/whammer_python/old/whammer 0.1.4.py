...
class UI_bar():
    ...
    def resize_image(self, width, height):
        ...
        for square in range(12):
            self.mysquares.append(UI_square('hot_key',
                                            (width//55)+(square)*(width//27.2), 
                                            self.y+height//3, 
                                            width//36, height//4))
...
class UI_square():
    ...
    def assign(self, contains):
        ...
        self.draw_image()
    def draw_image(self):
        if self.contains=='stab':
            self.image=hmm
        elif self.contains=='buckshot':
            self.image=hmm
...
def togfullscreen():
    ...
    if fullscrn == 0:
        ...
        botbar.resize_image(fullwidth, fullheight//9)
        fullscrn=1
    elif fullscrn == 1:
        global gamesize
        ...
        botbar.resize_image(gamesize[0], gamesize[1]//9)
        fullscrn=0
...
def player_view(my_screen, botbar):
    ...
    for square in botbar.mysquares:
        if square.image!='none':
            my_screen.blit(square.image, (square.x, square.y))
        else:
